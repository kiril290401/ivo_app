    ...
    >
      ...
      <div className="py-32 w-full flex flex-col justify-evenly">
        ...
        <div className="my-6 text-center">
          <h3>
            Ние предлагаме{" "}
            <span className="text-color_principal font-semibold">
              {" "}
              лицензирана пътна помощ{" "}
            </span>{" "}
            в Провадия 24/7, покривайки широк регион, включващ:
          </h3>
          <h4>
            Градове: Варна, Шумен, Девня, Нови пазар, Суворово, Вълчи дол,
            Дългопол, Повеляново и Айтос
          </h4>
          <h4>
            Села: Каспичан, Невша, Габърница, Слънчево, Гроздьово, Старо
            Оряхово, Шкорпиловци, Дъскотна, Бозвелийско, Аспарухово, Рояк и Авре
          </h4>
          <h4>Магистрали: АМ Хемус</h4>
          <p>
            Нашият екип от професионалисти е
            <span className="text-color_principal font-semibold">
              {" "}
              винаги в готовност{" "}
            </span>
            , за да ви осигури надеждна помощ на пътя, независимо къде се
            намирате в този обширен регион.
          </p>
        </div>
